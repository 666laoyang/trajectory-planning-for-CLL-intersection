...
dfL = pd.read_excel(f'C:\\Users\\User\\Desktop\\实验\\敏感性分析\\2借道长度\\{ppp}\\{ppp} 初步L{kkk}.xlsx')
...
if m.Status == GRB.OPTIMAL:
    ...
    x_result.to_excel(f"C:\\Users\\User\\Desktop\\实验\\敏感性分析\\2借道长度\\{ppp}\\{ppp} 最终x{kkk}.xlsx")
    L_result.to_excel(f"C:\\Users\\User\\Desktop\\实验\\敏感性分析\\2借道长度\\{ppp}\\{ppp} 最终L{kkk}.xlsx")
    a_result.to_excel(f"C:\\Users\\User\\Desktop\\实验\\敏感性分析\\2借道长度\\{ppp}\\{ppp} 最终a{kkk}.xlsx")
    v_result.to_excel(f"C:\\Users\\User\\Desktop\\实验\\敏感性分析\\2借道长度\\{ppp}\\{ppp} 最终v{kkk}.xlsx")