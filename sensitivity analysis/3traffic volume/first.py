...
if m.Status == GRB.OPTIMAL:
    ...
    x_result.to_excel(f"C:\\Users\\User\\Desktop\\实验\\敏感性分析\\3流量\\{ppp}\\{ppp} 初步x{kkk}.xlsx")
    L_result.to_excel(f"C:\\Users\\User\\Desktop\\实验\\敏感性分析\\3流量\\{ppp}\\{ppp} 初步L{kkk}.xlsx")
    a_result.to_excel(f"C:\\Users\\User\\Desktop\\实验\\敏感性分析\\3流量\\{ppp}\\{ppp} 初步a{kkk}.xlsx")
    v_result.to_excel(f"C:\\Users\\User\\Desktop\\实验\\敏感性分析\\3流量\\{ppp}\\{ppp} 初步v{kkk}.xlsx")